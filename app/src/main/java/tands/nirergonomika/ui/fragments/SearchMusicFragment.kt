...
import tands.nirergonomika.ui.adapters.SearchMusicAdapter
...
class SearchMusicFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if (ContextCompat.checkSelfPermission(activity!!.applicationContext, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            view.findViewById<RecyclerView>(R.id.search_recycler_view).apply {
                ...
                adapter = SearchMusicAdapter(findAllMusic()) { wave, musicFile ->
                    run {
                        ...
                        fragmentManager.beginTransaction()
                                .replace(R.id.main_layout, ProcessingFragment.newInstance(wave, musicFile), "processing_fragment")
                                .commit()
                    }
                }
            }
